...
Key_Handling::Key_Handling(): jump{}, left{}, right{}, shoot{},
    jump_key{sf::Keyboard::Up}, left_key{sf::Keyboard::Left},
    right_key{sf::Keyboard::Right}, shoot_key{sf::Keyboard::Space}{};

Key_Handling::Key_Handling(sf::Keyboard::Key j, sf::Keyboard::Key l,
    sf::Keyboard::Key r, sf::Keyboard::Key s)
    : jump{}, left{}, right{}, shoot{}, jump_key{j},
    left_key{l}, right_key{r}, shoot_key{s}{}
